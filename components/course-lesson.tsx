...
const CourseLesson = ({ courseDetails }: { courseDetails: CoursesType }) => {
    ...
    return (
        <View style={{ flex: 1, rowGap: 10, marginBottom: 10 }}>
            <View style={{ padding: 10, borderWidth: 1, borderColor: "#E1E2E5", borderRadius: 8 }}>
                <View>
                    {videoSections.map((item: string, index: number) => {
                        const isSectionVisible = visibleSections.has(item);

                        // Lọc các video theo section
